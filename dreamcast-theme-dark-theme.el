;;; dreamcast-theme-dark-theme.el --- A dark theme inspired by the Sega Dreamcast -*- lexical-binding: t; -*-
...
(provide 'dreamcast-theme-dark-theme)
(provide-theme 'dreamcast-theme-dark)

;;; dreamcast-theme-dark-theme.el ends here
